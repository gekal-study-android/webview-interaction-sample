...
| `PARTIAL_CUSTOM_TAB` | `setInitialActivityHeightPx()` | ボトムシート状に部分表示。下にアプリが見える |
...
| `TRUSTED_WEB_ACTIVITY` | `TrustedWebActivityIntentBuilder` | Digital Asset Links で検証できれば URL バーなし。できなければ Custom Tabs に落ちる |
